...
import com.example.globalExceptionHandlersks.exception.ResourceNotFoundException;
import com.example.globalExceptionHandlersks.model.Post;
import com.example.globalExceptionHandlersks.repository.PostRepository;
...
public class PostServiceImpl implements PostService{
    ...
    public PostResponse getAllPosts(int pageNo, int pageSize, String sortBy, String sortDir) {
        ...
        postResponse.setContent(content.toString());
        ...
        postResponse.setLast(String.valueOf(posts.isLast()));
